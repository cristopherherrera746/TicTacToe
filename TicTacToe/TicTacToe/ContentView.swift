...
struct Home: View {
    ...
    func checkMoves(player: String) -> Bool {
        for person in stride(from: 0, to: 9, by: 3) {
            if moves[person] == player &&
                moves[person+1] == player &&
                moves[person+2] == player {
        ...
        for person in 0...2 {
             if moves[person] == player &&
                moves[person+3] == player &&
                moves[person+6] == player {
